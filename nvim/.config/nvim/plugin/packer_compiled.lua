...
_G.packer_plugins = {
  ...
  ["bash-history.nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/bash-history.nvim",
    url = "https://github.com//Users/alex/Projects/bash-history.nvim"
  },
  ["cmp-buffer"] = {
    loaded = true,
  ...
  ["ejs-syntax"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/ejs-syntax",
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["guihua.lua"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/guihua.lua",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
